...
function App() {
    ...
    const [options, setOptions] = useState<DiagramOptions>({
        grouping: ['account', 'vpc', 'service', 'network'],
        showIsolated: false,
    });
        ...
        return (
            <section className="upload-section">
                ...
                <div className="options-panel">
                    ...
                    <GroupingItem groupName={'Network'} groupKey={'network'}/>
    ...
    const DiagramSection= ({d} : { d : DiagramResponse }) => {
        return (
            <section className="diagram-section">
                <ReactFlowProvider>
                    <DiagramCanvas
                        initialNodes={d.nodes}
                        initialEdges={d.edges}
                        metadata={d.metadata}
    ...
    return (
        <div className="app-container">
            ...
            <main className="main-content">
                ...
                {state === 'diagram' && diagram && (<DiagramSection d={diagram} />)}
            </main>
